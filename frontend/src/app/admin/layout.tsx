...
export default function AdminLayout({
    ...
    const menus = [
        ...
        { title: "Petugas", href: "/admin/petugas" },
        { title: "Destinasi Wisata", href: "/admin/destinasi" },
        { title: "Wisatawan", href: "/admin/wisatawan" },
        { title: "Pencarian", href: "/admin/pencarian" },
        { title: "Hasil Rekomendasi", href: "/admin/hasil-rekomendasi" },
        { title: "Lokasi Destinasi", href: "/admin/lokasi-destinasi" },
        { title: "Ulasan & Rating", href: "/admin/ulasan" },
