                        ...
                        {currentData.map((d, index) => (
                            <tr key={d.id} className="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td className="p-4 text-center">
                                    ...
                                    <button onClick={() => setDeleteId(d.id)} className="text-red-500 hover:text-red-700 mx-2 
                ...
                <div className="fixed inset-0 bg-slate-900/60 flex items-center justify-center z-60 p-4 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                            ...
                            <button onClick={() => setIsViewModalOpen(false)} className="text-slate-400 
                            hover:text-red-500 text-2xl font-bold leading-none transition-colors">&times;</button>
                        </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 font-medium">
                                        Dikelola oleh: <span className="text-slate-700">
                                            {viewingDestinasi.petugas?.username || "Admin (Pusat)"}</span>
                                    </p>
                                </div>
