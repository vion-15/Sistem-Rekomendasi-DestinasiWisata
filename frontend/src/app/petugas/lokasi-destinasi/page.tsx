            ...
            {isCardOpen && (
                ...
                animate-in slide-in-from-left-8 duration-300">
                    <div
                        ...
                        {selectedDest ? (
                            <div className="overflow-y-auto pr-3 flex-1 [&::-webkit-scrollbar]:hidden 
                            [-ms-overflow-style:none] scrollbar-none">
                                <div className="mb-6">
                                    <h1 className="text-2xl font-black text-blue-700 mb-2">{selectedDest.nama}</h1>
                                    <span className="inline-block bg-blue-100 text-blue-700 text-xs font-bold px-3 
                                ...
                                {!userLoc ? (
                                    ...
                                    <div className="text-sm text-blue-700 bg-blue-50 p-4 rounded-xl border border-blue-200 
                                    text-center animate-pulse font-medium">
