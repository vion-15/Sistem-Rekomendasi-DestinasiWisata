            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-8 gap-4">
                ...
                <div className="flex items-center gap-3">
                    <input
                        ...
                        outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-800 bg-white"
                    />
                    <button
                                ...
                                <tr key={u.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="p-4 text-center">
                                        <button
                                            ...
                                            className=" bg-white hover:bg-gray-100 text-green-600 px-3 py-1 text-sm 
                                            transition-colors mx-1 inline-block"
                                        >
                                            Lihat
                                        </button>
                                        <button
                                            onClick={() => setDeleteId(u.id)}
                                            className="bg-white hover:bg-gray-100 text-red-600 px-3 py-1 text-sm 
                                            transition-colors mx-1 inline-block"
                                        >
                                            Hapus
                                        </button>
                ...
                <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
                    <div className="bg-white p-6 rounded-xl w-full max-w-lg shadow-2xl relative">
                        <button
                            ...
                            className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 font-bold text-xl">&times;</button>
                        ...
                        {isDetailLoading ? (
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mt-6 pt-4 border-t border-gray-100 flex justify-between items-center">
                                    <button onClick={() => setDeleteId(selectedUlasan.id)} className="text-red-500 hover:text-red-700 
                                    font-medium text-sm flex items-center gap-1 transition-colors">
                                        <Trash2 /> Hapus Ulasan (Moderasi)
                                    </button>
                                    <button onClick={() => setIsDetailModalOpen(false)} className="px-4 py-2 bg-gray-100 
                                    text-gray-700 rounded-lg hover:bg-gray-200 font-medium transition-colors">
                                        Tutup
                                    </button>
                                </div>
                            </div>
