...
export default function WisatawanDashboard() {
    ...
    // Endpoint Logika AI + Cold Start untuk personalisasi Dashboard
    ...
    return (
        <div className="space-y-8">
            {/* Hero Section Banner */}
            <div className="bg-linear-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 sm:p-12 text-white shadow-lg relative overflow-hidden mb-10">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">

                    {/* Sisi Kiri: Judul Utama Halaman */}
                    ...
                    {/* Sisi Kanan: Tombol "Ayo Mulai" */}
                    <div className="shrink-0 mt-2 md:mt-0">
                        <Link
                            href="/wisatawan/cari-destinasi"
                            // Menggunakan warna tombol asli Anda (putih dengan teks biru) tapi dengan bentuk kotak sesuai desain
                            className="inline-flex items-center rounded-2xl justify-center bg-white text-blue-700 border-2 border-white px-8 py-3.5 font-bold text-base hover:bg-transparent hover:text-white transition-all duration-300 shadow-md"
                        >
                            Ayo Mulai
                        </Link>
                    </div>
            ...
            {/* Grid Destinasi Rekomendasi (Personalized) */}
            <div>
                <div className="flex justify-between items-end mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-800">Rekomendasi Untukmu</h2>
                            ...
                            <div key={d.id} className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all group flex flex-col">
                                <div className="h-48 relative overflow-hidden bg-slate-200">
                                    ...
                                    <div className="absolute top-4 left-4 flex flex-wrap gap-2">
                                        ...
                                        {/* Label Dinamis: Jika similarity_score dari Golang diset 1.0 artinya ini Cold Start (Acak) */}
                                        {d.similarity_score === 1.0 ? (
                                            ...
                                            /* Jika skornya ada dan bukan 1.0, berarti ini hasil hitungan AI */
