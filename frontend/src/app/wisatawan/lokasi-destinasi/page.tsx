...
export default function LokasiDestinasiPage() {
    ...
    return (
        <div className="fixed inset-0 top-[170px] bg-slate-100 overflow-hidden">
            ...
            {!isCardOpen && (
                <button
                    ...
                    className="absolute top-6 left-6 z-20 bg-white/95 backdrop-blur-md rounded-xl shadow-lg border border-slate-200 px-5 py-3 font-semibold text-slate-700 hover:text-blue-600 transition flex items-center gap-2"
                >
                    <Info size={18} />
                    Informasi Destinasi
                </button>
            ...
            {isCardOpen && (
                ...
                <div className="absolute top-6 left-6 bottom-6 w-[420px] z-20">

                    <div className="bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200 shadow-2xl h-full flex flex-col overflow-hidden">
                        ...
                        {selectedDest ? (
                            ...
                            <div className="flex-1 overflow-y-auto px-6 py-6">
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="bg-slate-50 rounded-2xl border border-slate-200 p-5 text-sm leading-7 text-slate-700">
                                ...
                                <div className="mt-8">
                                    ...
                                    {!userLoc ? (
                                        ...
                                        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-blue-700 animate-pulse">
